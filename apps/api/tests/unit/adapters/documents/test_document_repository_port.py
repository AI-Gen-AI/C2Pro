...
class TestIDocumentRepositoryInterface:
    ...
    async def test_add_document(self):
        ...
        await mock_repo.add(doc)
        
        mock_repo.add.assert_called_once_with(doc)
    ...
    async def test_get_by_id(self):
        ...
        result = await mock_repo.get_by_id(doc_id)
        
        mock_repo.get_by_id.assert_called_once_with(doc_id)
    ...
    async def test_get_document_with_clauses(self):
        ...
        await mock_repo.get_document_with_clauses(doc_id)
        
        mock_repo.get_document_with_clauses.assert_called_once_with(doc_id)
    ...
    async def test_update_status(self):
        ...
        await mock_repo.update_status(doc_id, DocumentStatus.PARSED)
        
        mock_repo.update_status.assert_called_once_with(doc_id, DocumentStatus.PARSED)
    ...
    async def test_update_status_with_error(self):
        ...
        mock_repo.update_status = AsyncMock()
        await mock_repo.update_status(doc_id, DocumentStatus.ERROR, "Parse failed")
        
        mock_repo.update_status.assert_called_once_with(doc_id, DocumentStatus.ERROR, "Parse failed")
    ...
    async def test_update_storage_path(self):
        ...
        await mock_repo.update_storage_path(doc_id, "/new/path.pdf")
        
        mock_repo.update_storage_path.assert_called_once_with(doc_id, "/new/path.pdf")
    ...
    async def test_list_for_project(self):
        ...
        result = await mock_repo.list_for_project(project_id, 0, 10)
        
        assert result == ([], 0)
        mock_repo.list_for_project.assert_called_once_with(project_id, 0, 10)
    ...
    async def test_add_clause(self):
        ...
        await mock_repo.add_clause(clause)
        
        mock_repo.add_clause.assert_called_once_with(clause)
    ...
    async def test_clause_exists(self):
        ...
        result = await mock_repo.clause_exists(clause_id)
        
        assert result is True
        mock_repo.clause_exists.assert_called_once_with(clause_id)
    ...
    async def test_get_clause_text_map(self):
        ...
        await mock_repo.get_clause_text_map(clause_ids)
        
        mock_repo.get_clause_text_map.assert_called_once_with(clause_ids)
    ...
    async def test_get_clauses_by_ids(self):
        ...
        await mock_repo.get_clauses_by_ids(clause_ids)
        
        mock_repo.get_clauses_by_ids.assert_called_once_with(clause_ids)
    ...
    async def test_get_clause_by_document_and_code(self):
        ...
        await mock_repo.get_clause_by_document_and_code(doc_id, "1.0")
        
        mock_repo.get_clause_by_document_and_code.assert_called_once_with(doc_id, "1.0")
    ...
    async def test_list_clauses_for_document(self):
        ...
        await mock_repo.list_clauses_for_document(doc_id)
        
        mock_repo.list_clauses_for_document.assert_called_once_with(doc_id)
