...
-- Tenant C has no pre-seeded row in any of the 4 target tables. Write-path
-- INSERT proofs use it exclusively so a "correct tenant succeeds" insert
-- never collides with a fixture-seeded row (notification_configs has a
-- UNIQUE(tenant_id) constraint; disclaimer_acceptances has a composite
-- unique constraint) -- a constraint violation would look identical to an
-- RLS rejection and silently defeat the proof.
INSERT INTO tenants (id, name, slug, subscription_plan) VALUES
    ...
    ('cccccccc-0000-0000-0000-000000000003', 'Tenant C', 'tenant-c', 'free');
...
INSERT INTO projects (id, tenant_id, name) VALUES
    ...
    ('cccccccc-cccc-cccc-cccc-00000000000c', 'cccccccc-0000-0000-0000-000000000003', 'Project C');
...
INSERT INTO dlq_failed_tasks (id, tenant_id, task_type, payload_json, error_message) VALUES
    ('11111111-1111-1111-1111-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000001', 'document_analysis', '{}'::jsonb, 'boom-a'),
    ('11111111-1111-1111-1111-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000002', 'document_analysis', '{}'::jsonb, 'boom-b');
...
INSERT INTO wbs_nodes (id, project_id, tenant_id, code, name, lft, rgt) VALUES
    ('22222222-2222-2222-2222-000000000001', 'cccccccc-cccc-cccc-cccc-00000000000a', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000001', 'A.1', 'Root A', 1, 2),
    ('22222222-2222-2222-2222-000000000002', 'cccccccc-cccc-cccc-cccc-00000000000b', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000002', 'B.1', 'Root B', 1, 2);
...
INSERT INTO notification_configs (id, tenant_id) VALUES
    ('33333333-3333-3333-3333-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-000000000001'),
    ('33333333-3333-3333-3333-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-000000000002');
