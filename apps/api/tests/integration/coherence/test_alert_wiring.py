...
from src.coherence.graph.nodes import format_output, _create_audit_incomplete_alert
from src.coherence.graph.state import CoherenceGraphState, EvaluationConfig
from src.coherence.models import FindingSignal, CoherenceCategory, EnrichedCoherenceResult
...
class TestBilingualization:
    ...
    def test_get_template_with_locale(self):
        ...
        from src.coherence.alert_generator import get_template, TEMPLATES_EN
