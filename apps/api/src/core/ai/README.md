...
```python
from src.core.ai.model_router import ModelRouter
...
```python
from src.core.ai.model_router import load_routing_config, validate_routing_config
...
**Solución:**
1. Verifica que el archivo está en: `apps/api/src/core/ai/model_routing.yaml`
