...
1. **`apps/api/src/modules/ai/llm_client.py`** (680 líneas)
...
2. **`apps/api/src/modules/ai/example_llm_client.py`**
...
3. **`apps/api/src/modules/ai/README_LLM_CLIENT.md`** (este archivo)
...
```python
from src.modules.ai.llm_client import create_llm_client
