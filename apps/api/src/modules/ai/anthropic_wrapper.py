...
from src.modules.ai.llm_client import LLMClient, LLMRequest
from src.modules.ai.model_router import AITaskType, ModelConfig, ModelTier, get_model_router
from src.services.anonymizer import get_pii_anonymizer_service, PiiAnonymizerService
...
def get_anthropic_wrapper() -> AnthropicWrapper:
    ...
    Example:
        from src.modules.ai.anthropic_wrapper import get_anthropic_wrapper, AIRequest, AITaskType
