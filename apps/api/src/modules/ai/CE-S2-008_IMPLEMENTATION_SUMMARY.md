...
### 2. `apps/api/src/modules/ai/example_prompts.py` (315 líneas)
...
### 3. `apps/api/src/modules/ai/test_prompts_simple.py` (75 líneas)
...
### 4. `apps/api/src/modules/ai/PROMPT_TEMPLATES_GUIDE.md` (800+ líneas)
...
- **Documentación**: `apps/api/src/modules/ai/PROMPT_TEMPLATES_GUIDE.md`
- **Ejemplos**: `apps/api/src/modules/ai/example_prompts.py`
- **Tests**: `apps/api/src/modules/ai/test_prompts_simple.py`
- **Código fuente**: `apps/api/src/modules/ai/prompts/__init__.py`
