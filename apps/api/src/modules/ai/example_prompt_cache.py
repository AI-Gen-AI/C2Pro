...
from src.modules.ai.prompt_cache import build_prompt_hash, get_prompt_cache_service
...
async def main():
    ...
    print("=" * 60)
    print("\n📚 Más info:")
    print("   - Documentación: apps/api/src/modules/ai/README_PROMPT_CACHE.md")
    print("   - Código: apps/api/src/modules/ai/prompt_cache.py")
