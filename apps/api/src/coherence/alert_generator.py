...
TEMPLATES: dict[str, str] = {
    ...
    "DET-CRS-CONBUD": "El total del contrato difiere del total del presupuesto.",
    "DET-CRS-WBSBUD": "La suma de la EDT/WBS difiere del total del presupuesto.",
    "DET-CRS-BOMBUD": "La suma del BOM difiere del total del presupuesto.",
    "DET-CRS-NEGMARGIN": "El presupuesto supera el importe del contrato (margen negativo).",
    "DET-CRS-RISKCONT": "Un riesgo identificado supera el fondo de contingencia.",
    "DET-CRS-SCHDEAD": "El cronograma finaliza despues del plazo contractual.",
    ...
    "DET-LEG-REVIEW": "La revision del contrato lleva {days_since} dias sin realizarse (ultima revision: {last_review_date}).",
...
RULE_TITLES: dict[str, str] = {
    ...
    "DET-CRS-CONBUD": "Descuadre contrato vs presupuesto",
    "DET-CRS-WBSBUD": "Descuadre EDT/WBS vs presupuesto",
    "DET-CRS-BOMBUD": "Descuadre BOM vs presupuesto",
    "DET-CRS-NEGMARGIN": "Margen negativo (presupuesto > contrato)",
    "DET-CRS-RISKCONT": "Riesgo supera la contingencia",
    "DET-CRS-SCHDEAD": "Cronograma excede el plazo del contrato",
    ...
    "DET-LEG-REVIEW": "Revision de contrato vencida",
...
RULE_SEVERITIES: dict[str, AlertSeverity] = {
    ...
    "DET-CRS-CONBUD": AlertSeverity.HIGH,
    "DET-CRS-WBSBUD": AlertSeverity.HIGH,
    "DET-CRS-BOMBUD": AlertSeverity.HIGH,
    "DET-CRS-NEGMARGIN": AlertSeverity.HIGH,
    "DET-CRS-RISKCONT": AlertSeverity.HIGH,
    "DET-CRS-SCHDEAD": AlertSeverity.HIGH,
    ...
    "DET-LEG-REVIEW": AlertSeverity.HIGH,
...
class AlertGenerator:
    ...
    def _category_for(self, rule_id: str) -> str | None:
        ...
        rule_to_raw: dict[str, str] = {
            ...
            "DET-BUD-SUM": "BUDGET",
            "DET-CRS-CONBUD": "BUDGET",
            "DET-CRS-WBSBUD": "BUDGET",
            "DET-CRS-BOMBUD": "BUDGET",
            "DET-CRS-NEGMARGIN": "BUDGET",
            "DET-CRS-RISKCONT": "BUDGET",
            "DET-CRS-SCHDEAD": "SCHEDULE",
