...
--
-- IMPORTANT: This script was tested and applied directly via psql.
-- The alembic migration file (20260403_0003) documents the same changes
-- but was applied via this script due to asyncpg transaction issues.
-- =====================================================
...
-- When app.current_tenant is not set, NULLIF returns NULL → no rows returned
...
ALTER VIEW v_project_stakeholders SET (security_invoker = true);
...
ALTER VIEW v_raci_matrix SET (security_invoker = true);

-- --- v_coherence_breakdown ---
-- Reads from analyses table (not coherence_results)
...
ALTER VIEW v_coherence_breakdown SET (security_invoker = true);
...
ALTER VIEW v_project_wbs SET (security_invoker = true);
...
ALTER VIEW v_project_clauses SET (security_invoker = true);
...
ALTER VIEW v_project_alerts SET (security_invoker = true);

-- --- v_project_bom ---
-- Uses procurement_bom_items (NOT bom_items)
...
ALTER VIEW v_project_bom SET (security_invoker = true);
