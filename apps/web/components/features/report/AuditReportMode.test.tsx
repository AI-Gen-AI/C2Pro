 ...
 * Audit Report export mode: composes the audit report from project sources.
 */
import { describe, expect, it, vi, beforeEach } from "vitest";
import { renderWithProviders, screen, waitFor } from "@/src/tests/test-utils";
import { AuditReportMode } from "./AuditReportMode";
...
describe("AuditReportMode", () => {
  ...
  it("composes the audit report from project, dashboard, alerts, and document sources", async () => {
    renderWithProviders(<AuditReportMode projectId="proj-188" />);
