 ...
 */
import type { SecretChannelClerkResponseValues } from "./secretChannelClerkResponseValues";

export interface SecretChannelClerkResponse {
  bundle_version: string;
  values: SecretChannelClerkResponseValues;
}
