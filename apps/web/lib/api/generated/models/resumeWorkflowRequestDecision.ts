 ...
 */
export type ResumeWorkflowRequestDecision =
  (typeof ResumeWorkflowRequestDecision)[keyof typeof ResumeWorkflowRequestDecision];

export const ResumeWorkflowRequestDecision = {
  approve: "approve",
  reject: "reject",
} as const;
