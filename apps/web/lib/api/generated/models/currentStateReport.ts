 ...
 */
import type { CurrentStateSections } from "./currentStateSections";
...
export interface CurrentStateReport {
  ...
  /** sha256 over project identity and section content, excluding generated_at. Two reports with the same fingerprint describe the same state. */
