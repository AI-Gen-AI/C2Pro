...
export type GlobalV2Status =
  (typeof GlobalV2Status)[keyof typeof GlobalV2Status];

export const GlobalV2Status = {
  scored: "scored",
  partial: "partial",
  insufficient_active_weight: "insufficient_active_weight",
