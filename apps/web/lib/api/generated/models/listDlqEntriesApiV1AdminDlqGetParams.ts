 ...
 */
import type { ListDlqEntriesApiV1AdminDlqGetStatus } from "./listDlqEntriesApiV1AdminDlqGetStatus";

export type ListDlqEntriesApiV1AdminDlqGetParams = {
  status?: ListDlqEntriesApiV1AdminDlqGetStatus;
  /**
   * @minimum 1
   * @maximum 500
   */
