 ...
 */
import type { ResumeWorkflowRequestDecision } from "./resumeWorkflowRequestDecision";
...
export interface ResumeWorkflowRequest {
  /** The reviewer's decision: 'approve' to resume workflow, 'reject' to terminate */
  decision: ResumeWorkflowRequestDecision;
  /**
   * Optional feedback or reason for the decision (required for rejections)
   * @maxLength 5000
   */
  feedback?: string;
}
