...
export type ListDlqEntriesApiV1AdminDlqGetStatus =
  (typeof ListDlqEntriesApiV1AdminDlqGetStatus)[keyof typeof ListDlqEntriesApiV1AdminDlqGetStatus];

export const ListDlqEntriesApiV1AdminDlqGetStatus = {
  pending: "pending",
  retrying: "retrying",
  exhausted: "exhausted",
} as const;
