...
export interface AnalyzeRequest {
  /** Project ID to analyze documents from */
  project_id: string;
  /** Optional specific document ID. If not provided, analyzes all project documents. */
  document_id?: string | null;
  /** Analysis prompt/question for the documents */
