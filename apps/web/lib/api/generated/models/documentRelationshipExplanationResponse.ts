 ...
 */
import type { RelationshipExplanationCitationResponse } from "./relationshipExplanationCitationResponse";

/**
 * Structured relationship explanation payload for a document.
 */
export interface DocumentRelationshipExplanationResponse {
  document_id: string;
  summary: string;
  strongest_cluster: string;
  review_priority: string;
  latest_signal: string;
  citations: RelationshipExplanationCitationResponse[];
}
