...
export interface Evidence {
  /** The ID of the clause that serves as direct evidence. */
  source_clause_id: string;
  /** A concise claim or summary derived from the evidence. */
  claim: string;
  /** The direct quote from the clause text that serves as evidence. */
  quote: string;
}
