 ...
 */
import type { CoherenceDataSubScores } from "./coherenceDataSubScores";
...
export interface CoherenceData {
  ...
  sub_scores?: CoherenceDataSubScores;
  /** Alerts counted by the coherence evaluation that produced the score. This can differ from the Alerts section, which lists the project alert register. */
  evaluation_alert_count: number;
  /** Latest project activity considered by the coherence dashboard; not the evaluation time. */
