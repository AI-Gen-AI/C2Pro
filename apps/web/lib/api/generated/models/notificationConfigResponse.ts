...
import type { NotificationConfigResponseCustomHeaders } from "./notificationConfigResponseCustomHeaders";
...
export interface NotificationConfigResponse {
  ...
  /** Email recipients for email notifications */
  email_recipients?: string[] | null;
  /** Slack webhook URL (partial masking for security) */
  slack_webhook_url?: string | null;
  /** Generic webhook URL */
  webhook_url?: string | null;
  /** Webhook authentication token (masked) */
  webhook_auth_token?: string | null;
  /** Custom headers for webhook requests (values masked) */
  custom_headers?: NotificationConfigResponseCustomHeaders;
}
