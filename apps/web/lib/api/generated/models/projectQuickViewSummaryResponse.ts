 ...
 */
import type { ProjectQuickViewAlertResponse } from "./projectQuickViewAlertResponse";

/**
 * Project quick-view summary used by the frontend sheet.
 */
export interface ProjectQuickViewSummaryResponse {
  project_id: string;
  tenant_id: string;
  name: string;
  code?: string | null;
  ...
  top_alerts?: ProjectQuickViewAlertResponse[];
  updated_at: string;
}
