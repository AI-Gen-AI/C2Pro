-- TS-E2E-SEC-TNT-001
-- Auth bootstrap lookup functions
-- Temporary dual-track migration while Alembic and Supabase SQL ownership remain split.
...
REVOKE ALL ON FUNCTION auth_bootstrap.create_tenant(text, text, text) FROM PUBLIC;
