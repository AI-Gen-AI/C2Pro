-- TS-DB-MIG-REC-005
-- MCP function compatibility surface

DROP FUNCTION IF EXISTS public.fn_get_clause_by_id(uuid, uuid);
...
DROP FUNCTION IF EXISTS public.fn_get_stakeholder_by_id(uuid, uuid);
