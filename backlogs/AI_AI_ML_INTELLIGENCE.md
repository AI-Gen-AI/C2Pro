...
| [ ] | P1 | `TASK-AI-009` | `TASK-216` | Create CLI command `python -m core.ai.sync_prompts` to push all templates on deployment `[-] In Progress @2026-04-20 - Activated as next priority after completing TASK-AI-008.` | `docs/prompt_analytics/LANGSMITH_INTEGRATION_PLAN.md` (Phase 2) |
