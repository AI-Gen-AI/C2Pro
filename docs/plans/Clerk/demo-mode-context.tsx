 ...
 * 
 * Location: apps/web/src/contexts/demo-mode.tsx
 * 
...
/**
 * Sample data structure for demo mode
 */
...
export function DemoModeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (organization) {
      const isDemo = (organization.publicMetadata as any)?.is_demo === true
  ...
  alerts: [
    {
      ...
      type: 'scope_mismatch',
      severity: 'high',
      message: 'WBS item "Mechanical Assembly" not covered by any contract clause',
    ...
    },
    {
      ...
      severity: 'medium',
      message: 'BOM item "Centrifugal Pump" cost exceeds allocated budget by 12%',
    ...
    },
    {
      ...
      severity: 'high',
      message: 'Critical path item delivery timeline conflicts with contract milestone',
    ...
    },
    {
      ...
      severity: 'critical',
      message: 'Environmental permits clause missing required compliance standards',
...
/**
 * Hook to get demo data for a specific entity
 */
export function useDemoData<T>(
  entityType: keyof DemoDataType
): T[] {
...
/**
 * Component to show demo mode indicator in header
 */
...
/**
 * Component to toggle between demo and production
 */
