...
This section groups operational procedures, environment setup notes, migrations, and troubleshooting guides.
...
- [Supabase Windows config report](./SUPABASE_WINDOWS_CONFIG_REPORT.md)
- [Infra E2E runbook](./I13_REAL_E2E_INFRA_RUNBOOK.md)
- [Test instructions](./INSTRUCCIONES_TESTS.md)
