...
- `@qa plan [module/increment]`: **(Phase 1)** Formulates a logical Audit Plan. For Backend/AI, it strictly references `docs/testing/PHASE4_TDD_IMPLEMENTATION_ROADMAP.md`. For UI/Frontend, it strictly references `docs/architecture/C2PRO_TECHNICAL_DESIGN_DOCUMENT_v4_0.md`.
...
_Reference: [Insert either PHASE4 Roadmap or FRONTEND Master Plan here]_

- `[TEST-ID-01]`: Description of behavior to verify.
- `[TEST-ID-02]`: Description of edge case or failure mode.
  _(Wait for user to reply with `@qa execute` or "Proceed")_
