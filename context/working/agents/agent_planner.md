...
- **Backend:** Strict Modular Monolith with Hexagonal Architecture. Inter-module communication happens _only_ via DTOs and Ports. `clauses` is the central source of truth for traceability.
...
_Status: Plan ready. @qa-agent, please begin Step 2._
```
