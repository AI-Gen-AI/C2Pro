...
### 2026-03-04 AGENT-B reconciliation pass

Batch command pattern used:
`PYENV_VERSION=3.11.14 python -m pytest <test_path> -q --basetemp .pytest-tmp`

Result summary: all AGENT-B scoped test modules are currently `BLOCKED_COLLECTION` in this environment because `apps/api/tests/conftest.py` imports `pytest_asyncio`, which is not installed.

TI-056 | BLOCKED_COLLECTION | apps/api/tests/modules/anonymizer/application/test_anonymization_service.py | python -m pytest apps/api/tests/modules/anonymizer/application/test_anonymization_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-057 | BLOCKED_COLLECTION | apps/api/tests/modules/anonymizer/application/test_tenant_anonymization_config_service.py | python -m pytest apps/api/tests/modules/anonymizer/application/test_tenant_anonymization_config_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-058 | BLOCKED_COLLECTION | apps/api/tests/modules/anonymizer/domain/test_pii_detector_service.py | python -m pytest apps/api/tests/modules/anonymizer/domain/test_pii_detector_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-059 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/application/services/test_budget_tracker.py | python -m pytest apps/api/tests/modules/coherence/application/services/test_budget_tracker.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-060 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/application/test_calculate_coherence_use_case.py | python -m pytest apps/api/tests/modules/coherence/application/test_calculate_coherence_use_case.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-061 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/application/test_coherence_calculation_service.py | python -m pytest apps/api/tests/modules/coherence/application/test_coherence_calculation_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-062 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/application/test_i6_coherence_engine_service.py | python -m pytest apps/api/tests/modules/coherence/application/test_i6_coherence_engine_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-063 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/application/test_recalculate_on_alert_use_case.py | python -m pytest apps/api/tests/modules/coherence/application/test_recalculate_on_alert_use_case.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-064 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_alert_mapping.py | python -m pytest apps/api/tests/modules/coherence/domain/test_alert_mapping.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-065 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_anti_gaming.py | python -m pytest apps/api/tests/modules/coherence/domain/test_anti_gaming.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-066 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_category_enum_weights.py | python -m pytest apps/api/tests/modules/coherence/domain/test_category_enum_weights.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-067 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_coherence_rule_engine.py | python -m pytest apps/api/tests/modules/coherence/domain/test_coherence_rule_engine.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-068 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_custom_weights.py | python -m pytest apps/api/tests/modules/coherence/domain/test_custom_weights.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-069 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_gamification_rules.py | python -m pytest apps/api/tests/modules/coherence/domain/test_gamification_rules.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-070 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_global_score_calculator.py | python -m pytest apps/api/tests/modules/coherence/domain/test_global_score_calculator.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-071 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_i6_alert_payload_contract.py | python -m pytest apps/api/tests/modules/coherence/domain/test_i6_alert_payload_contract.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-072 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_i6_coherence_rules.py | python -m pytest apps/api/tests/modules/coherence/domain/test_i6_coherence_rules.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-073 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_legal_rules.py | python -m pytest apps/api/tests/modules/coherence/domain/test_legal_rules.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-074 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_quality_rules.py | python -m pytest apps/api/tests/modules/coherence/domain/test_quality_rules.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-075 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_rules_engine.py | python -m pytest apps/api/tests/modules/coherence/domain/test_rules_engine.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-076 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/domain/test_subscore_calculator.py | python -m pytest apps/api/tests/modules/coherence/domain/test_subscore_calculator.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-077 | BLOCKED_COLLECTION | apps/api/tests/modules/coherence/integration/test_coherence_repository.py | python -m pytest apps/api/tests/modules/coherence/integration/test_coherence_repository.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-085 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/adapters/http/test_document_upload.py | python -m pytest apps/api/tests/modules/documents/adapters/http/test_document_upload.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-086 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/application/services/test_extraction_services.py | python -m pytest apps/api/tests/modules/documents/application/services/test_extraction_services.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-087 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/application/test_clause_extraction_service.py | python -m pytest apps/api/tests/modules/documents/application/test_clause_extraction_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-088 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/application/test_extract_clauses_use_case.py | python -m pytest apps/api/tests/modules/documents/application/test_extract_clauses_use_case.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-089 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/application/test_extract_entities_use_case.py | python -m pytest apps/api/tests/modules/documents/application/test_extract_entities_use_case.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-090 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/application/test_upload_document_use_case.py | python -m pytest apps/api/tests/modules/documents/application/test_upload_document_use_case.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-091 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_clause.py | python -m pytest apps/api/tests/modules/documents/domain/test_clause.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-092 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_clause_entity.py | python -m pytest apps/api/tests/modules/documents/domain/test_clause_entity.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-093 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_clause_type_classification.py | python -m pytest apps/api/tests/modules/documents/domain/test_clause_type_classification.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-094 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_confidence_scoring.py | python -m pytest apps/api/tests/modules/documents/domain/test_confidence_scoring.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-095 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_date_entity_extractor.py | python -m pytest apps/api/tests/modules/documents/domain/test_date_entity_extractor.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-096 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_document_entity.py | python -m pytest apps/api/tests/modules/documents/domain/test_document_entity.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-097 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_entity_extraction_dates.py | python -m pytest apps/api/tests/modules/documents/domain/test_entity_extraction_dates.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-098 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_entity_extraction_durations.py | python -m pytest apps/api/tests/modules/documents/domain/test_entity_extraction_durations.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-099 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_entity_extraction_money.py | python -m pytest apps/api/tests/modules/documents/domain/test_entity_extraction_money.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-100 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_entity_extraction_stakeholders.py | python -m pytest apps/api/tests/modules/documents/domain/test_entity_extraction_stakeholders.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-101 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_money_entity_extractor.py | python -m pytest apps/api/tests/modules/documents/domain/test_money_entity_extractor.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-102 | BLOCKED_COLLECTION | apps/api/tests/modules/documents/domain/test_subclause_hierarchy.py | python -m pytest apps/api/tests/modules/documents/domain/test_subclause_hierarchy.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-103 | BLOCKED_COLLECTION | apps/api/tests/modules/extraction/application/test_i3_clause_extraction_service.py | python -m pytest apps/api/tests/modules/extraction/application/test_i3_clause_extraction_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-104 | BLOCKED_COLLECTION | apps/api/tests/modules/extraction/domain/test_i3_clause_extraction_domain.py | python -m pytest apps/api/tests/modules/extraction/domain/test_i3_clause_extraction_domain.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-114 | BLOCKED_COLLECTION | apps/api/tests/modules/ingestion/adapters/test_i2_ocr_table_parsing.py | python -m pytest apps/api/tests/modules/ingestion/adapters/test_i2_ocr_table_parsing.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-115 | BLOCKED_COLLECTION | apps/api/tests/modules/ingestion/domain/test_i1_canonical_ingestion_contract.py | python -m pytest apps/api/tests/modules/ingestion/domain/test_i1_canonical_ingestion_contract.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-157 | BLOCKED_COLLECTION | apps/api/tests/modules/retrieval/application/test_i4_hybrid_retrieval_service.py | python -m pytest apps/api/tests/modules/retrieval/application/test_i4_hybrid_retrieval_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-158 | BLOCKED_COLLECTION | apps/api/tests/modules/retrieval/domain/test_i4_query_router.py | python -m pytest apps/api/tests/modules/retrieval/domain/test_i4_query_router.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-159 | BLOCKED_COLLECTION | apps/api/tests/modules/scoring/application/test_i7_coherence_scoring_service.py | python -m pytest apps/api/tests/modules/scoring/application/test_i7_coherence_scoring_service.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-160 | BLOCKED_COLLECTION | apps/api/tests/modules/scoring/domain/test_i7_score_aggregation.py | python -m pytest apps/api/tests/modules/scoring/domain/test_i7_score_aggregation.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.
TI-161 | BLOCKED_COLLECTION | apps/api/tests/modules/scoring/domain/test_i7_tenant_project_profiles.py | python -m pytest apps/api/tests/modules/scoring/domain/test_i7_tenant_project_profiles.py -q --basetemp .pytest-tmp | Collection failed immediately because `pytest_asyncio` is missing from the active interpreter. | infra | Install or vendor `pytest-asyncio` for the PYENV 3.11.14 environment before re-running AGENT-B triage.

FIX-014 | TI-056 to TI-077, TI-085 to TI-104, TI-114 to TI-115, TI-157 to TI-161 | P1 | infra | Missing pytest async plugin dependency for module suites | Provision `pytest-asyncio` in the active PYENV interpreter (or align to the project test environment), then re-run AGENT-B in the same command pattern. | pytest-asyncio
