...
## 3. Context & Knowledge
### Architecture & Scope
- **Source of Truth:** The unified workflow for the agent fleet is governed by the `agents.md` files.
- **Where You Operate:**
  - **Can write:** `/docs/**/*.md`, `.github/agents/**/*.md`, and `README.md`.
...
*Note: I noticed `agents.md` still referenced `setup-v1.md` for the `@dev-deploy` agent. I have updated `agents.md` to point to the new `setup-v2.md`.*
```
