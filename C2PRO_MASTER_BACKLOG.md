...
|[ ]|P1|`TASK-OPS-DOCFLOW-013`|`TASK-OPS-DOCFLOW-012`|Fix INF coverage blocker: align HITL checkpoint metric label contract and raise scoped observability/resilience/security coverage gate to `>=70%`.|`TASK-OPS-DOCFLOW-012 local verification`|
|[ ]|P1|`TASK-OPS-DOCFLOW-014`|`TASK-OPS-DOCFLOW-012`|Fix full backend suite collection blocker: restore `golden.evaluators` imports or migrate `tests/golden` fixtures to the current golden corpus package.|`TASK-OPS-DOCFLOW-012 local verification`|
