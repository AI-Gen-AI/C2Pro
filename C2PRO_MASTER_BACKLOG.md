...
|[ ]|P0|`TASK-OPS-DOCFLOW-007`|`TASK-OPS-DOCFLOW-006`|Add backend integration spec for real extraction outputs: clauses, risks, and expected categories.|`blackboard/coverage-gates/REAL-DOCUMENT-OPERABILITY-SPEC-PLAN.md`|
|[ ]|P0|`TASK-OPS-DOCFLOW-008`|`TASK-OPS-DOCFLOW-007`|Add backend integration spec for real coherence score, score reason/version, missing-dimension semantics, and alerts.|`blackboard/coverage-gates/REAL-DOCUMENT-OPERABILITY-SPEC-PLAN.md`|
|[ ]|P1|`TASK-OPS-DOCFLOW-009`|`TASK-OPS-DOCFLOW-008`|Add authenticated API retrieval contract for processed document, coherence result, and project alerts with tenant isolation.|`blackboard/coverage-gates/REAL-DOCUMENT-OPERABILITY-SPEC-PLAN.md`|
|[ ]|P1|`TASK-OPS-DOCFLOW-010`|`TASK-OPS-DOCFLOW-009`|Add frontend display spec for real backend-shaped coherence and alerts payloads.|`blackboard/coverage-gates/REAL-DOCUMENT-OPERABILITY-SPEC-PLAN.md`|
|[ ]|P1|`TASK-OPS-DOCFLOW-011`|`TASK-OPS-DOCFLOW-008`|Add golden regression spec for structured real-document outputs using score ranges and alert category/severity assertions.|`blackboard/coverage-gates/REAL-DOCUMENT-OPERABILITY-SPEC-PLAN.md`|
|[ ]|P1|`TASK-OPS-DOCFLOW-012`|`TASK-OPS-DOCFLOW-009,TASK-OPS-DOCFLOW-010,TASK-OPS-DOCFLOW-011`|Add CI quality gate for real document flow plus coverage, lint, and full backend-suite evidence or approved blocker tracking.|`blackboard/coverage-gates/REAL-DOCUMENT-OPERABILITY-SPEC-PLAN.md`|
